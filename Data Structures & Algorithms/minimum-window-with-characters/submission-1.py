class Solution:
    def minWindow(self, s: str, t: str) -> str:
        ...
        if we remove a letter from our window while shortening it we need to check if
        the condition cur == req is still maintained if not then go back to increasing
